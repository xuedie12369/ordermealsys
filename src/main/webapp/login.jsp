<!DOCTYPE html>
<!-- saved from url=(0198)https://passport.meituan.com/account/unitivelogin?service=www&continue=http%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttp%253A%252F%252Fwww.meituan.com%252Faccount%252Fuserinfo%252F -->
<html>
<head>
...
<link rel="apple-touch-icon"
	href="https://s0.meituan.net/img/apple-touch-icon-ipad.png">
<link rel="shortcut icon"
	href="https://p1.meituan.net/tuanpic/1e4d71577b7922f1ab756d202e1ac4af1342.ico">
<link rel="icon"
	href="https://p1.meituan.net/tuanpic/1e4d71577b7922f1ab756d202e1ac4af1342.ico"
	sizes="16x16 32x32">

<link rel="alternate" href="http://www.meituan.com/feed" title="订阅更新"
	type="application/rss+xml">

<link rel="canonical"
	href="https://passport.meituan.com/account/unitivelogin?service=www&amp;continue=http%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttp%253A%252F%252Fwww.meituan.com%252Faccount%252Fuserinfo%252F">
...
.select-radio+label:hover, .ui-radio+label:hover, .ui-radio[value=hover]+label,
	[value=hover].select-radio+label {
	padding-left: 20px;
	background:
...
.select-checkbox+label:hover, .ui-checkbox+label:hover, .ui-checkbox[value=hover]+label,
	[value=hover].select-checkbox+label {
	padding-left: 20px;
	background:
...
.icon-status-sprite, .tip-status, .tip-status--error, .tip-status--large,
	...
	{
	background-image:
		url(//s0.meituan.net/bs/file/?f=fe-sso-fs:build/assets/icons.c1b3784.png);
...
.theme--jiaoma .header .site-logo {
	width: 130px;
	height: 60px;
	background-position: -258px -748px;
	background-image:
		url(//s0.meituan.net/bs/file/?f=fe-sso-fs:build/assets/sp-normal.2ee5c09.png);
...
.theme--jinrong .btn, .theme--jinrong-mobile .btn {
	...
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#ff8901',
		endColorstr='#f76120', GradientType=0)
}
...
.theme--maoyan_pianfang .header.cf .site-logo {
	width: 239px;
	height: 29px;
	background-position: -624px -677px;
	background-image:
		url(//s0.meituan.net/bs/file/?f=fe-sso-fs:build/assets/sp-normal.2ee5c09.png);
	text-indent: -200px
}
...
.theme--maoyan .header--mini {
	border-bottom-color: #e02025
}

.theme--maoyan .header--mini .site-logo {
	width: 133px;
	background-position: -536px -748px;
	background-image:
		url(//s0.meituan.net/bs/file/?f=fe-sso-fs:build/assets/sp-normal.2ee5c09.png);
	height: 40px;
	margin-top: -2px
...
.theme--maoyan .btn {
	...
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#ec454a',
		endColorstr='#e02025', GradientType=0)
}
...
.theme--mos .btn {
	...
	color: #FFF;
	background: #18f;
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0, #18f),
		color-stop(100%, #0077d1));
	background: -webkit-linear-gradient(top, #18f 0, #0077d1 100%);
	background: linear-gradient(to bottom, #18f 0, #0077d1 100%);
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#1188ff',
		endColorstr='#0077d1', GradientType=0)
}
...
.theme--mos .login-section .login-type i {
	width: 14px;
	height: 14px;
	background-position: -905px -677px;
	background-image:
		url(//s0.meituan.net/bs/file/?f=fe-sso-fs:build/assets/sp-normal.2ee5c09.png)
}
...
.theme--mos .login-section .login-type--normal i {
	width: 14px;
	height: 14px;
	background-position: -863px -677px;
	background-image:
		url(//s0.meituan.net/bs/file/?f=fe-sso-fs:build/assets/sp-normal.2ee5c09.png)
}
...
.theme--waimai_developer .header .site-logo {
	width: 144px;
	height: 60px;
	background-position: -114px -748px;
	background-image:
		url(//s0.meituan.net/bs/file/?f=fe-sso-fs:build/assets/sp-normal.2ee5c09.png);
	background-size: initial
}
...
.theme--waimai_developer .footer .copyright .link,
	.theme--waimai_developer .footer .copyright a {
	color: #ccc
}
...
.theme--waimai_developer .login-section .login-type--normal i {
	width: 14px;
	height: 12px;
	background-position: -919px -677px;
	background-image:
		url(//s0.meituan.net/bs/file/?f=fe-sso-fs:build/assets/sp-normal.2ee5c09.png)
}
...
@media ( -webkit-min-device-pixel-ratio :1.5) { @
	supports (background-size:contain ){ .theme--www .header
		.site-logo{background-image:url(//s0.meituan.net/bs/file/?f=fe-sso-fs:build/assets/sp-retina.b95a7dd.png);
...
.login-section .login-type i, .login-section .login-type--normal i {
	width: 14px;
	height: 14px;
	background-image:
		url(//s0.meituan.net/bs/file/?f=fe-sso-fs:build/assets/sp-normal.2ee5c09.png)
...
.login-section .validate-info {
	min-height: 18px;
	margin-top: 0
}

.login-section .login-type {
	font-weight: 400;
	color: #666
}

.login-section .login-type a {
	position: relative;
	float: right;
	padding-right: 16px;
	font-size: 12px;
...
.login-section .login-type--normal i {
	background-position: -891px -677px
}

.login-section .form--stack {
	width: 270px
}

.login-section .form--stack .btn, .login-section .form--stack .btn-hot {
	width: 100%
}

.login-section .form--stack h2 {
	font-weight: 400;
	color: #666
}

.login-section .form--stack h2 a {
	position: relative;
	float: right;
	padding-right: 16px;
	font-size: 12px;
...
.login-section .form-field--higher {
	padding-bottom: 22px
}

.login-section .form-field--verify-mobile {
	padding: 0;
	z-index: 10;
	position: absolute;
	right: 0
...
.login-section .form-field--verify-mobile .btn-mini {
	background: 0 0;
	border: none;
	letter-spacing: 0;
	color: #666
...
.login-section .form-field--verify-mobile .btn-mini:hover {
	background: 0 0
}

.login-section .form-field--verify-mobile .verify-tip {
	font-size: 12px;
	color: #666
}

.login-section .form-field--verify-mobile .error {
	color: #f76120
}

.login-section .form-field--captcha-mobile {
	padding-bottom: 5px;
	height: 36px
}

.login-section .form-field--captcha-mobile .f-text {
	padding-left: 33px;
	width: 48px
}

.login-section .form-field--captcha-mobile .icon-captcha {
	width: 18px;
	height: 18px;
	background-position: -1250px -653px;
	background-image:
		url(//s0.meituan.net/bs/file/?f=fe-sso-fs:build/assets/sp-normal.2ee5c09.png)
}

.login-section .form-field--auto-login {
	padding-top: 0;
	font-size: 12px
}

.login-section .form-field--auto-login label {
	font-size: 12px
}

.login-section .form-field--auto-login .ui-checkbox+label.normal {
	padding-left: 20px
}

.login-section .form-field--auto-login .forget-password {
	float: right
}
...
.login-section .form-field--icon .f-text {
	width: 230px;
	padding-left: 33px
}

.login-section .form-field--icon .icon-user {
	width: 18px;
	height: 18px;
...
.login-section .form-field--icon .icon-password {
	width: 18px;
	height: 18px;
...
.login-section .form-field--icon .icon-phone {
	width: 18px;
	height: 18px;
...
.login-section .verify-tip {
	font-size: 12px;
	color: #666
}

.login-section .verify-tip--error {
	color: #f76120
}

.login-section .signup-guide {
	color: #666
}

.login-section .treaty-block {
	padding: 10px 0;
	color: #999;
	font-size: 12px
}

.login-section .pwdtip-block {
	padding: 0;
	color: #999;
	font-size: 12px
}
...
.login-section .oauth-wrapper .title-wrapper {
	position: relative;
	margin-bottom: 30px;
...
.login-section .oauth-wrapper .title {
	position: absolute;
	top: -10px;
	left: 50%;
	margin-left: -75px;
...
.login-section .oauth-wrapper .oauth {
	padding-left: 88px
}

.login-section .oauth-wrapper .oauth__link {
	float: left;
	margin-right: 20px;
	width: 18px;
	height: 18px;
...
.login-section .oauth-wrapper .oauth__link:hover {
	width: 18px;
	height: 18px;
...
.login-section .oauth-wrapper .oauth__link--alipay {
	width: 18px;
	height: 18px;
...
.login-section .oauth-wrapper .oauth__link--alipay:hover {
	width: 18px;
	height: 18px;
...
.login-section .oauth-wrapper .oauth__link--weibo {
	width: 18px;
	height: 18px;
...
.login-section .oauth-wrapper .oauth__link--weibo:hover {
	width: 18px;
	height: 18px;
...
.stick-qrcode .stick-qrcode__pos {
	width: 74px;
	height: 74px;
	background-position: -114px -808px;
	background-image:
		url(//s0.meituan.net/bs/file/?f=fe-sso-fs:build/assets/sp-normal.2ee5c09.png);
	position: absolute;
	top: 128px;
...
.pg-unitive-login .site-body {
	margin: 0 auto 70px;
	width: 980px
}

.pg-unitive-login .promotion-banner {
	float: left;
	height: 370px;
	margin: 0 115px 0 0;
	width: 480px
...
.pg-unitive-login .login-section {
	float: left;
	padding-top: 0
}
</style>
...
<script async="" src="./登录 _ 美团网_files/saved_resource"></script>
<script>
	!function(e, t, n) {
		function s() {
			var e = t.createElement("script");
			e.async = !0, e.src = "//s0.meituan." + (-1 === t.location.protocol.indexOf("https") ? "net" : "com") + "/bs/js/?f=mta-js:mta.min.js";var n = t.getElementsByTagName("script")[0];
			n.parentNode.insertBefore(e, n)
		}
		if (e.MeituanAnalyticsObject = n, e[n] = e[n] || function() {
				(e[n].q = e[n].q || []).push(arguments)
			}, "complete" === t.readyState) s();else {
			var i = "addEventListener",
				r = "attachEvent";
			if (e[i]) e[i]("load", s, !1);
			else if (e[r]) e[r]("onload", s);else {
				var a = e.onload;
				e.onload = function() {
					s(), a && a()
				}
		...
		if (t && !("_mta" in t)) {
			...
			if ("file:" !== s) {
				...
				t.prototype.open = function(t, n, a, o, l) {
					...
					return this._startTime = (new Date).getTime(), r.apply(this, arguments)
				};
				...
				t.prototype.send = function(t) {
						...
						if (0 !== n._url.indexOf(s + "//frep.meituan.net/_.gif")) {
							...
							if (n.response) switch (n.responseType) {
								...
								case "moz-blob":
									...
									r = n.response.byteLength;case "document":
					...
					if (o in this) {
						...
						this[o]("load", i), this[o]("error", i), this[o]("abort", i)
					} else {
						var r = this[a];
						this[a] = function(t) {
							r && r.apply(this, arguments), 4 === this.readyState && e.mta && n(this, t)
						}
					}
...
<body class="pg-unitive-login theme--www">
	...
	<div class="site-body-wrapper">
		<div class="site-body cf">
			<div class="promotion-banner">
				<img src="1.png" width="480" height="370" alt="美团网">
			</div>
			...
			<div class="login-section"
				...
				<form id="J-normal-form" method="POST" class="form form--stack">
					...
					<div class="form-field form-field--ops">
						...
						<input type="hidden" name="fingerprint" class="J-fingerprint"
							...
							data-mtevent="login.normal.submit" id="login"  type="button"
				...
				<form id="J-mobile-form" action="/"
					class="form form--stack J-wwwtracker-form" style="display:none">
					<div class="validate-info" style="visibility:hidden"></div>

					<span class="login-type login-type--normal"
						data-mtevent="login.normal.switch"> <a id="J-normal-link"
						href="https://passport.meituan.com/account/unitivelogin?service=www&amp;continue=http%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttp%253A%252F%252Fwww.meituan.com%252Faccount%252Fuserinfo%252F">
							普通方式登录 <i></i>
					</a> 账号登录
					</span>
					...
					<div class="J-info form-field form-field--icon">
						<i class="icon icon-phone"></i> <input type="text"
							id="login-mobile" class="f-text" name="mobile" value=""
							placeholder="手机号">
					</div>
					<div
						class="form-field J-form-field-captcha-mobile form-field--captcha-mobile"
						style="display:none;">
						<i class="icon icon-captcha"></i> <input type="text"
							id="login-captcha" class="f-text" name="login-captcha"
							placeholder="验证码" autocomplete="off"> <img height="34"
							width="61" class="login-captcha-img" id="login-captcha-img"
							src="./登录 _ 美团网_files/captcha"> <a tabindex="-1"
							class="captcha-refresh inline-link" href="javascript:void(0)">看不清楚？换一张</a>
					</div>

					<div class="form-field form-field--icon">
						<i class="icon icon-password"></i> <input type="text" name="code"
							id="login-verify-code" class="f-text" autocomplete="off" value=""
							placeholder="动态码">
						<div class="form-field form-field--verify-mobile"
							style="top:19px;">
							<input type="button" class="btn-normal btn-mini"
								id="J-verify-btn" value="获取手机动态码">
						</div>
						<i class="form-uuid" style="display:none">0fc97bb13f42488cbe1c.1522231209.1.0.0</i>
					</div>
					...
					<div class="form-field form-field--auto-login cf">
						<a tabindex="-1"
							href="https://passport.meituan.com/account/retrievepassword?service=www&amp;continue=http%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttp%253A%252F%252Fwww.meituan.com%252Faccount%252Fuserinfo%252F"
							target="_top" class="forget-password">忘记密码？</a> <input
							type="checkbox" value="1" name="auto_login" id="mobile-autologin"
							class="f-check ui-checkbox"> <label class="normal"
							for="mobile-autologin">7天内自动登录</label>
					</div>
					<div class="form-field form-field--ops">
						<input type="hidden" name="origin" value="account-login">
						<input type="hidden" name="fingerprint" class="J-fingerprint"
							value="0-3-1-"> <input type="hidden" name="csrf"
							value="k4QzSxUf-Cz2mTPNNE8kzfrIZEp-eegMnYek"> <input
							data-mtevent="login.mobile.submit" id="btnSend" type="button"
							class="btn" name="commit" value="登录">
							
					这是文本:	<input type="text" id="wenben" />
					...
					<p class="J-treaty-block treaty-block" style="display:none">
						提示： 未注册美团账号的手机号，登录时将自动注册美团账号，且代表您已同意<a
							href="http://www.meituan.com/about/terms" class="j-terms"
		...
		<div id="list1">
				...
				<div class="oauth-wrapper">
					...
					<div class="oauth cf">
						<a class="oauth__link oauth__link--qq"
							href="https://passport.meituan.com/account/connect/tencent"
							data-mtevent="{&quot;la&quot;:&quot;oauth/qq&quot;}"
							target="_blank"></a> <a class="oauth__link oauth__link--weibo"
							href="https://passport.meituan.com/account/connect/sina"
	...
	<footer class="footer">
		<div class="site-info-nav cf">
			<ul>
				<li class="first"><a rel="nofollow"
					href="http://meituan.com/about/">关于美团</a></li>
				<li><a rel="nofollow" href="http://meituan.com/commitment/">美团承诺</a></li>
				<li><a rel="nofollow"
					href="http://www.hotjob.cn/wt/meituan/web/index?brandCode=meituan""="">加入我们</a></li>
				<li><a rel="nofollow"
					href="http://emis.meishi.meituan.com/merchantsSettled">商家入驻</a></li>
				<li><a rel="nofollow" href="http://meituan.com/help/faq">帮助中心</a></li>
				<li class="last"><a href="http://meituan.com/mobile">美团手机版</a></li>
			</ul>
			<a class="site-info-nav__commitment"
				href="http://meituan.com/commitment/"> <img width="276"
				height="24" src="./登录 _ 美团网_files/footer-commitment.png" alt="美团保障">
			</a>
		</div>
		<div class="copyright">
			<p>
				©<span>2018</span> <a href="http://meituan.com/">美团网团购</a>
				meituan.com <a href="http://www.miibeian.gov.cn/" target="_blank">京ICP证070791号</a>
				京公网安备11010502025545号<a href="http://meituan.com/about/rules"
	...
	<span id="csrf" style="display:none">k4QzSxUf-Cz2mTPNNE8kzfrIZEp-eegMnYek</span>

	<script src="./登录 _ 美团网_files/saved_resource(2)"></script>
	<script src="./登录 _ 美团网_files/saved_resource(3)"></script>


	<input type="button" id="login1" name="btnSend" value="asdasd" />
