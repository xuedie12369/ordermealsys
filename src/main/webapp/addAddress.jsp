	...
	<body>
		<form class="form-horizontal" role="form" id="addAddressForm">
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" class="form-control" name="consigneeName" placeholder="请输入收货人姓名">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="tel" class="form-control" id="tel" name="tel" placeholder="请输入您的电话">
				</div>
...
<div class="form-group">
          ...
          <input type="radio" name="sex" value="0"> 女
			...
			<div class="col-sm-offset-2 col-sm-3 " id="save">
				<button type="button"  class="btn btn-info">进入邮箱</button>
			</div>
			</div>
		</form>
